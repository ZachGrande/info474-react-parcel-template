          ...
          <div className="col">
            ...
            <div className="row py-3"> {/* map / list row */}
              <div className="col"> {/* map col */}
                <svg id="map" className="tooltip-svg" width={1000} height={600} style={{ border: "1px solid black", backgroundColor: "#212529" }} viewBox={`${x} ${y} ${width} ${height}`}>
              ...
              <div className="col my-2 px-0">
                ...
                <div>
                  ...
                  <span className="pl-1">{this.setDisplayPrice("1")}</span>
                </div>
                <div>
                  ...
                  <span className="pl-1">{this.setDisplayPrice("2")}</span>
                </div>
                <div>
                  ...
                  <span className="pl-1">{this.setDisplayPrice("3")}</span>
                </div>
                <div>
                  ...
                  <span className="pl-1">{this.setDisplayPrice("4")}</span>
                </div>
                <div>
                  ...
                  <span className="pl-1">{this.setDisplayPrice("5")}</span>
                </div>
                <hr></hr>
                <h4>Top Cities:</h4>
                {listData[0] &&
                  <ol id="city-list">
                    <li id="city-1" className="animate__animated animate__lightSpeedInRight">{"1. " + listData[0].city}</li>
                    <li id="city-2" className="animate__animated animate__lightSpeedInRight">{"2. " + listData[1].city}</li>
                    <li id="city-3" className="animate__animated animate__lightSpeedInRight">{"3. " + listData[2].city}</li>
                    <li id="city-4" className="animate__animated animate__lightSpeedInRight">{"4. " + listData[3].city}</li>
                    <li id="city-5" className="animate__animated animate__lightSpeedInRight">{"5. " + listData[4].city}</li>
                    <li id="city-6" className="animate__animated animate__lightSpeedInRight">{"6. " + listData[5].city}</li>
                    <li id="city-7" className="animate__animated animate__lightSpeedInRight">{"7. " + listData[6].city}</li>
                    <li id="city-8" className="animate__animated animate__lightSpeedInRight">{"8. " + listData[7].city}</li>
                    <li id="city-9" className="animate__animated animate__lightSpeedInRight">{"9. " + listData[8].city}</li>
                    <li id="city-10" className="animate__animated animate__lightSpeedInRight">{"10. " + listData[9].city}</li>
                  </ol>}
              </div>
            </div>
            <div className="row">
